...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed top-0 flex flex-col px-5 left-0 bg-white dark:bg-gray-900 text-gray-900 h-screen transition-all duration-300 ease-in-out z-50 border-0
        ${
          isExpanded || isMobileOpen
            ? "w-[290px] lg:border-r lg:border-gray-200 dark:lg:border-gray-800"
            : "w-[90px] hidden lg:block"  // Hide on mobile when collapsed
        }
