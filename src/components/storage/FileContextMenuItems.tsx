...
export function getFileContextMenuItems(options: FileContextMenuOptions): ContextMenuItem[] {
  ...
  if (options.fileType === "file" && options.onDownload) {
    items.push({
      id: "download",
      label: "Download",
      icon: (
  ...
  if (options.onStar) {
    items.push({
      id: "star",
      label: options.isStarred ? "Unstar" : "Star",
      icon: options.isStarred ? (
  ...
  // Divider (removed to eliminate gap)
  // Star/Unstar is now directly adjacent to Rename
  ...
  // Delete (divider removed for compact menu)
  if (options.onDelete) {
    items.push({
      id: "delete",
      label: "Move to trash",
